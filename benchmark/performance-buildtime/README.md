...
monorepo size scales. See [`../README.md`](../README.md) for full methodology, tier
...
- **`documentation-payload`** (fixed `stress`-sized fixture, two variants) -- minimal
  ...
  independent of variable count (see `../README.md`).
...
(`parseSchemaFile()` is internal, not public API). See `../README.md`.
