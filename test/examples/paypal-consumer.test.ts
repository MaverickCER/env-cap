...
const ARTIFACTS = ["src/env.manifest.ts", "src/env.manifest.snapshot.json", "docs/ENVIRONMENT.md", ".env.example"];
const installed = isInstalled(EXAMPLE);

describe(EXAMPLE, () => {
  it.skipIf(!installed)("validates its own contract and paypal-addon's cross-package contract together", () => {
