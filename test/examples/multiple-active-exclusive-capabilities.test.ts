...
import { isInstalled, runExpectingFailure } from "./support.js";
 ...
 * for this example and therefore **no golden comparison** -- `generate:env`
...
describe(EXAMPLE, () => {
  it.skipIf(!installed)("generate:env always rejects two active members of the same exclusiveGroup", () => {
    const output = runExpectingFailure(EXAMPLE, "generate:env");
