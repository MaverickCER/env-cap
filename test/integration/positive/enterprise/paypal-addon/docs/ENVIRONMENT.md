...
_Generated 2026-09-11T20:45:31.210Z_
...
|---|---|
| `PAYPAL_CLIENT_ID` | [paypal-addon (`src/env.schema.ts`)](#paypal-addon-paypal_client_id) |
| `PAYPAL_CLIENT_SECRET` | [paypal-addon (`src/env.schema.ts`)](#paypal-addon-paypal_client_secret) |
| `PAYPAL_WEBHOOK_ID` | [paypal-addon (`src/env.schema.ts`)](#paypal-addon-paypal_webhook_id) |
