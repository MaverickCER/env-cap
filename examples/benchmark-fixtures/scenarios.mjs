...
// cost leaking into what the runtime example measures. See ../PERFORMANCE.md
 ...
 * other three (see PERFORMANCE.md's "never compare" rule).
 */
export const TIERS = {
...
// Runtime: cold-start only. See PERFORMANCE.md for why validation-failures,
