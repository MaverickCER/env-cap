...
[`../PERFORMANCE.md`](../PERFORMANCE.md) for full methodology, tier definitions, and the
...
`../performance-buildtime`'s realistic ones -- see `../PERFORMANCE.md`'s "Runtime fixture
...
with `cold-start` or doesn't correspond to a real code path -- see `../PERFORMANCE.md`.
