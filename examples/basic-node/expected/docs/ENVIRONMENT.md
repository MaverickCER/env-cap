...
_Generated 2026-08-03T23:31:58.492Z_
...
| Owner | Variables |
|---|---|
| platform-team | [`DATABASE_URL` (app)](#app-database_url), [`PORT` (app)](#app-port), [`LOG_LEVEL` (app)](#app-log_level), [`PAYMENT_PROVIDER` (app)](#app-payment_provider), [`STRIPE_KEY` (app)](#app-stripe_key) |
...
| [`STRIPE_KEY`](#app-stripe_key) | platform-team | 2026-09-01 (**29d remaining**) | Rotate in the Stripe dashboard (Developers -> API keys), then redeploy. Rotate every 90 days. |
