 ...
 * test/examples/examples.test.ts in the main repo for the companion
 * regression test proving this config actually *catches* a violation too,
 * using a synthetic snippet rather than a real file that would otherwise
 * have to fail `npm run lint` on purpose.
 */
