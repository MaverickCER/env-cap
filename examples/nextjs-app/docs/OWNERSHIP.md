...
|---|---|---|---|---|
| todos-public (`src/features/todos/env.public.schema.ts`) | platform-team | 1 | src/app/page.tsx | 1 |
| todos-server (`src/features/todos/env.server.schema.ts`) | platform-team | 3 | src/app/api/todos/route.ts, src/lib/session.ts, src/lib/store.ts | 3 |
